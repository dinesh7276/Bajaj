...
app.post("/bfhl", (req, res) => {
  ...
  res.json({
    is_success: true,
    user_id: "Polisetty Dinesh",  // Replace with actual logic to generate user_id
    email: "polisettydinesh70@gmail.com",         // Replace with actual email logic
    roll_number: "21BCE7276",        // Replace with actual roll number logic
    numbers,
    alphabets,
